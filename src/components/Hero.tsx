...
const Hero = () => {
  ...
  return (
    <section id="home" className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 min-h-screen flex items-center overflow-hidden">
      ...
      {showMarquee && (
        <div className="absolute top-0 left-0 right-0 z-30 bg-gradient-to-r from-orange-600/95 to-yellow-600/95 backdrop-blur-sm border-b border-white/10 shadow-[0_4px_20px_rgba(0,0,0,0.2)]">
