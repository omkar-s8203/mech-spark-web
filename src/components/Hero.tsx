      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        ...
        <div className="hidden lg:grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left animate-fade-in-left">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
              Ready to Bring{' '}
              <span className="bg-gradient-to-r from-orange-400 to-yellow-400 bg-clip-text text-transparent animate-shimmer bg-[length:200%_100%]">
                Bigger, Better
              </span>{' '}
              & Stronger Technology
            </h1>
            <p className="mt-6 text-xl text-gray-300 max-w-2xl animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
              A leading company focused on accelerating the technology and growing exponentially. 
              Innovate. Design. Build. Lead the Future.
            </p>
            <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center lg:justify-start animate-fade-in-up" style={{ animationDelay: '0.6s' }}>
              {/* <Button 
                size="lg" 
...
>
  <Button 
    size="lg" 
    className="bg-gradient-to-r from-orange-500 to-yellow-500 hover:from-orange-600 hover:to-yellow-600 text-lg px-8 py-3 transform hover:scale-105 transition-all duration-300 animate-glow shadow-2xl"
  >
    Get Started
  </Button>
</a>
          ...
          <div className="relative animate-scale-in-center" style={{ animationDelay: '0.8s' }}>
            <div className="bg-gradient-to-br from-orange-500/20 to-yellow-500/20 rounded-full w-96 h-96 mx-auto flex items-center justify-center animate-glow" style={{ animationDuration: '4s' }}>
              <div className="bg-gradient-to-br from-orange-500/30 to-yellow-500/30 rounded-full w-80 h-80 flex items-center justify-center animate-pulse" style={{ animationDuration: '6s' }}>
                <div className="bg-gradient-to-br from-orange-500/40 to-yellow-500/40 rounded-full w-64 h-64 flex items-center justify-center">
                  ...
                  <svg className="w-32 h-32 text-white animate-wave" fill="currentColor" viewBox="0 0 24 24" style={{ animationDuration: '4s' }}>
            ...
            <div className="absolute -top-4 -left-4 bg-white/10 backdrop-blur-sm rounded-lg p-4 animate-float transform hover:scale-110 transition-all duration-300 cursor-pointer shadow-lg animate-fade-in-left" style={{ animationDelay: '1.0s' }}>
            ...
            <div className="absolute -bottom-4 -right-4 bg-white/10 backdrop-blur-sm rounded-lg p-4 animate-float transform hover:scale-110 transition-all duration-300 cursor-pointer shadow-lg animate-fade-in-right" style={{ animationDelay: '1.2s', animationDuration: '4s' }}>
            ...
            <div className="absolute top-1/2 -left-8 bg-white/10 backdrop-blur-sm rounded-lg p-4 animate-float transform hover:scale-110 transition-all duration-300 cursor-pointer shadow-lg animate-fade-in-left" style={{ animationDelay: '1.4s', animationDuration: '5s' }}>
        ...
        <div className="lg:hidden text-center">
          <div className="animate-fade-in-up">
            {/* Mobile Hero Icon */}
            <div className="mb-8">
              <div className="bg-gradient-to-br from-orange-500/20 to-yellow-500/20 rounded-full w-32 h-32 mx-auto flex items-center justify-center animate-glow mb-6" style={{ animationDuration: '4s' }}>
                <svg className="w-16 h-16 text-white animate-wave" fill="currentColor" viewBox="0 0 24 24" style={{ animationDuration: '3s' }}>
                  <path d="M12 2L2 7v10c0 5.55 3.84 9.74 9 10 5.16-.26 9-4.45 9-10V7l-10-5z"/>
                  <path d="M9 12l2 2 4-4" stroke="currentColor" strokeWidth="2" fill="none"/>
                </svg>
              </div>
              ...
              <div className="flex flex-wrap justify-center gap-2 mb-8">
                <div className="bg-white/10 backdrop-blur-sm rounded-full px-3 py-1 text-orange-400 text-sm font-medium animate-fade-in-left" style={{ animationDelay: '0.3s' }}>
                  CAD Design
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-full px-3 py-1 text-yellow-400 text-sm font-medium animate-fade-in-up" style={{ animationDelay: '0.5s' }}>
                  3D Printing
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-full px-3 py-1 text-orange-300 text-sm font-medium animate-fade-in-right" style={{ animationDelay: '0.7s' }}>
                  R&D
                </div>
              </div>
            </div>

            <h1 className="text-3xl sm:text-4xl font-bold text-white leading-tight mb-6 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
              Ready to Bring{' '}
              <span className="bg-gradient-to-r from-orange-400 to-yellow-400 bg-clip-text text-transparent animate-shimmer bg-[length:200%_100%]">
                Bigger, Better
              </span>{' '}
            ...
            <p className="text-lg text-gray-300 max-w-2xl mx-auto mb-8 animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
              A leading company focused on accelerating technology and growing exponentially. 
              Innovate. Design. Build. Lead the Future.
            </p>
            
            <div className="flex flex-col gap-4 animate-fade-in-up" style={{ animationDelay: '0.6s' }}>
              {/* <Button 
                size="lg" 
...
>
  ...
  >
    Get Started
            ...
            {/* Mobile Stats */}
            <div className="grid grid-cols-3 gap-4 mt-12 animate-fade-in-up" style={{ animationDelay: '0.8s' }}>
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 transform hover:scale-105 transition-all duration-300">
                <div className="text-2xl font-bold text-orange-400 animate-glow">500+</div>
                <div className="text-gray-300 text-sm">Projects</div>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 transform hover:scale-105 transition-all duration-300">
                <div className="text-2xl font-bold text-yellow-400 animate-glow">50+</div>
                <div className="text-gray-300 text-sm">Clients</div>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 transform hover:scale-105 transition-all duration-300">
                <div className="text-2xl font-bold text-orange-300 animate-glow">5+</div>
